...
Run the following command to verify docker compose is installed:
```bash
  $ docker compose version
  
  Docker Compose version v2.6.0
```
If you haven't installed docker compose, you can install it using [the instructions here](https://docs.docker.com/compose/install/). 

## Docker compose commands
Now, let us see what are the commands we can use with docker compose 
